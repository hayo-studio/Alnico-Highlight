<?php
/*
Plugin Name: Alnico Highlight
Plugin URI: https://github.com/hayo-studio/Alnico-Highlight
Description: Alnico Syntax highlighting for the Web.
Author: iCodeChef, Snownee
Version: 1.0
Author URI: http://hayo-studio.cn
License: MIT
*/
...
function pure_highlightjs_assets() {
    ...
    wp_enqueue_script( 'pure-highlightjs', PURE_HIGHLIGHTJS_PLUGIN_URL . 'highlight/highlight.js', array(), '0.9.2', true );
}
